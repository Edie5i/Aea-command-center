...
const examQuestions: Question[] = [
  ...
  {
    id: 9,
    text: '¿Qué indica una línea continua en el pavimento?',
    options: [
      { label: 'Que el carril está a punto de terminar.', value: 'a' },
      { label: 'Que no se debe rebasar ni cambiar de carril.', value: 'b' },
      { label: 'Que es una zona de velocidad reducida.', value: 'c' },
      { label: 'Que es un carril preferencial para bicicletas.', value: 'd' },
    ],
    correctAnswer: 'b',
  },
  {
  ...
  {
    id: 12,
    text: 'Para los motociclistas, ¿quiénes deben usar casco de seguridad certificado?',
    options: [
      { label: 'Solo el conductor.', value: 'a' },
      { label: 'Tanto el conductor como el acompañante.', value: 'b' },
      { label: 'Solo en vías rápidas.', value: 'c' },
      { label: 'Es opcional.', value: 'd' },
    ],
    correctAnswer: 'b',
  },
  {
  ...
  {
    id: 16,
    text: '¿Dónde deben circular preferentemente los ciclistas?',
    options: [
      { label: 'En el carril de extrema izquierda.', value: 'a' },
      { label: 'En el carril de extrema derecha o en la ciclovía.', value: 'b' },
      { label: 'Por la banqueta.', value: 'c' },
      { label: 'En medio de los carriles.', value: 'd' },
    ],
    correctAnswer: 'b',
  },
  {
  ...
  {
    id: 18,
    text: 'El uso del claxon (bocina) está permitido para:',
    options: [
      { label: 'Saludar a un amigo.', value: 'a' },
      { label: 'Apurar al coche de adelante.', value: 'b' },
      { label: 'Expresar enojo.', value: 'c' },
      { label: 'Evitar un accidente de tránsito de manera justificada.', value: 'd' },
    ],
    correctAnswer: 'd',
  },
  {
