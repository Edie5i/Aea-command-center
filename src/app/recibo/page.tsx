      ...
      <div className="min-h-screen bg-gray-100 flex items-start justify-center p-6 pt-10">
        <div className="w-full max-w-2xl bg-white shadow-xl rounded-xl overflow-hidden">
          ...
          <div className="px-8 py-8">
            ...
            {/* Firma / Sello */}
            <div className="mt-12 pt-6 border-t border-gray-200 flex justify-between text-center">
              <div>
                <div className="h-10" />
                <div className="border-t border-gray-400 w-44 pt-2 text-xs text-gray-400">Firma del instructor</div>
              </div>
              <div>
                <div className="h-10" />
                <div className="border-t border-gray-400 w-44 pt-2 text-xs text-gray-400">Sello</div>
              </div>
            </div>
            ...
            <button
              ...
              className="no-print mt-8 w-full bg-[#1B4FD8] hover:bg-blue-700 text-white font-semibold py-3 rounded-lg transition-colors"
            >
              Guardar como PDF
            </button>
          </div>
